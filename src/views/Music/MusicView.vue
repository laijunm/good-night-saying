      ...
      <div class="recordsaying-body-station">
        ...
        <ul class="recordsaying-station-lists">
          <li
            ...
            @click="
              playStation(
                'https://3079037647.qnqcdn.net:22443/qn-0T5WUFJz5IiFWIBAkVCUkI1EnGmQUMT4.audio.pcdn.xmcdn.com/storages/5402-audiofreehighqps/B8/9A/GKwRIJIHHyVzAJpxzwGxbb76.m4a',
                'spaceTime'
              )
            "
          >
          ...
          <li
            ...
            @click="
              playStation(
                'https://3079037648.qnqcdn.net:22443/qn-2UgA5lSKUIiFWIBAkVCUkI1EnGmQUMT4.audio.pcdn.xmcdn.com/storages/f2d4-audiofreehighqps/4C/04/GKwRIDoHHUJJAKBDvwGwiLq4.m4a',
                'together'
              )
            "
          >
          ...
          <li
            ...
            @click="
              playStation(
                'https://1851079102.qnqcdn.net:22443/qn-Ud84RSiXcIiFWIBAkVCUkI1EnGmQUMT4.audio.pcdn.xmcdn.com/storages/55bd-audiofreehighqps/C8/4C/GKwRIJEHGI_PAG8jbgGukG-A.m4a',
                'protect'
              )
            "
          >
          ...
          <li
            ...
            @click="
              playStation(
                'https://1851079096.qnqcdn.net:22443/qn-hMKnCF8y1IiFWIBAkVCUkI1EnGmQUMT4.audio.pcdn.xmcdn.com/storages/d564-audiofreehighqps/00/0C/GKwRIRwHFJkwAKKFrQGs38mA.m4a',
                'starSky'
              )
            "
          >
